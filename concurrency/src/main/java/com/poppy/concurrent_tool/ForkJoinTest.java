...
public class ForkJoinTest {
    ...
    public static void main(String... args) throws InterruptedException, ExecutionException {
        ...
        // 但我觉得这道题主要考查的是对并发编程的基本思路吧，应该不会考察太深的，所以不用在意了，
        // 要是确实是要把怎么样避免OOM也考虑到的话暂时还没想到应该怎样解决）
        int[] array = IntStream.rangeClosed(0, 1_00_000).toArray();
        ...
        //同步调用
        Integer returnVal = forkJoinPool.invoke(task);
    ...
    static class Task extends RecursiveTask<Integer> {
        ...
        protected Integer compute() {
            ...
            if (high - low <= threshold) { //到了不能再Fork的阈值后直接循环累加返回
                ...
                //invokeAll(leftHandTask,rightHandTask);//与上面的fork方法有什么不同
