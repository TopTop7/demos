...
public class CdConsumerTopicB {
    ...
    public static void main(String[] args) {
        ...
        //实例化连接工厂
        connectionFactory = new ActiveMQConnectionFactory(CdConsumerTopicB.USERNAME,
                CdConsumerTopicB.PASSWORD, CdConsumerTopicB.BROKEURL);
